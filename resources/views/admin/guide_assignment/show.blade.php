...
<div class="container">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <p>
                        ...
                        <br>
                        <small class="text-muted">{{ \Illuminate\Support\Carbon::parse($guideAssignment->schedule->start_date)->diffForHumans() }}</small>
                    </p>
                </div>
                <div class="col-md-6">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <p>
                        ...
                        <br>
                        <small class="text-muted">{{ \Illuminate\Support\Carbon::parse($guideAssignment->assigned_at)->diffForHumans() }}</small>
                    </p>
                </div>
            </div>
    ...
    <div class="mt-4 d-flex gap-2">
        ...
        <form action="{{ route('admin.guide-assignments.destroy', $guideAssignment->id) }}" method="POST" style="display:inline;"
