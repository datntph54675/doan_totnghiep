            ...
            <div class="card-body">
                ...
                <dl class="row">
                    ...
                    <dd class="col-sm-8">{{ $booking->schedule->start_date->format('d/m/Y') ?? '-' }} -
                        {{ $booking->schedule->end_date->format('d/m/Y') ?? '-' }}
                    </dd>
                    ...
                    <dt class="col-sm-4">Xác nhận admin</dt>
                    <dd class="col-sm-8">
                        @if ($booking->admin_confirmed)
                        <span class="badge bg-success">Đã xác nhận</span>
                        @elseif($booking->payment_status === 'paid')
                        <span class="badge bg-warning text-dark">Chờ admin xác nhận</span>
                        @else
                        <span class="badge bg-secondary">Chưa đủ điều kiện xác nhận</span>
                        @endif
                    </dd>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.bookings.confirm', $booking) }}" method="POST" class="mb-3"
                    ...
                    <button type="submit" class="btn btn-success">
                        <i class="fas fa-check me-1"></i> Xác nhận booking cho khách
                    </button>
                </form>
                @endif
