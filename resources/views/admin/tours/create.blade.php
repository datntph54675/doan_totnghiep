...
@section('content')
    <div class="mb-4">
        ...
        <h2 class="fw-bold text-dark">Thêm Tour mới</h2>
    </div>
        ...
        <div class="card-body p-4">
            <form action="{{ route('admin.tours.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        <label for="price" class="form-label fw-bold text-secondary">Giá (VND)</label>
                    ...
                    <div class="col-md-6 mb-4">
                        <label for="duration" class="form-label fw-bold text-secondary">Thời lượng (ngày)</label>
                    ...
                    <div class="col-12 mb-4">
                        ...
                        <textarea name="description" id="description" rows="4"
                            ...
                            placeholder="Nhập mô tả tour...">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-12 mb-4">
                        ...
                        <textarea name="policy" id="policy" rows="4"
                            ...
                            placeholder="Nhập chính sách tour...">{{ old('policy') }}</textarea>
                        @error('policy')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
