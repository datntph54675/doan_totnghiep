...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="d-flex gap-2">
        ...
        <a href="{{ route('admin.tours.departure-schedules.create', $tour->tour_id) }}" class="btn btn-primary shadow-sm px-4">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @endphp
                            <span class="text-muted">{{ data_get($assignedGuide, 'guide.user.fullname', 'Chưa gán') }}</span>
                        </td>
                        <td class="pe-4 text-end">
                            <div class="btn-group">
                                ...
                                <form action="{{ route('admin.tours.departure-schedules.destroy', ['tour' => $tour->tour_id, 'schedule' => $schedule->schedule_id]) }}" method="POST"
