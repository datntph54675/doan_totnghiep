    ...
    <form action="{{ route('admin.tours.departure-schedules.store', $tour->tour_id) }}" method="POST">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="number" name="max_people" id="max_people" min="1" class="form-control @error('max_people') is-invalid @enderror" value="{{ old('max_people') }}" required>
            ...
            <div class="col-md-6 mb-3">
                ...
                <select name="status" id="status" class="form-select @error('status') is-invalid @enderror" required>
                    ...
                    <option value="ongoing" @selected(old('status') == 'ongoing')>Đang diễn ra</option>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="meeting_point" id="meeting_point" class="form-control @error('meeting_point') is-invalid @enderror" value="{{ old('meeting_point') }}">
