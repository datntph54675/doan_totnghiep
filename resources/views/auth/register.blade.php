...
@section('title', 'Đăng ký tài khoản - VietTour')
...
<style>
    .auth-container {
        ...
        padding: 40px 20px; background: var(--bg-light);
    }
    .auth-card {
    ...
    .auth-header h1 { font-size: 1.5rem; font-weight: 800; color: var(--text-dark); margin-bottom: 8px; }
    ...
    .row-input i { position: absolute; left: 14px; top: 14px; color: #94a3b8; font-size: 0.9rem; }
    .form-control {
    ...
    .btn-auth:hover { background: var(--primary-dark); transform: translateY(-1px); box-shadow: 0 4px 12px rgba(0,102,204,0.2); }
    
    .auth-footer { text-align: center; margin-top: 24px; font-size: 0.9rem; color: var(--text-mid); }
    .auth-footer a { color: var(--primary); font-weight: 600; }
    .auth-footer a:hover { text-decoration: underline; }
    
    .error-msg { color: #dc2626; font-size: 0.75rem; margin-top: 6px; display: block; font-weight: 500; }
</style>
@endsection
