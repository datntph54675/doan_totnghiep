...
<div class="stats-grid">
    ...
    <div class="stat-card">
        ...
        <div>
            <div class="stat-value">{{ $currentPassengerTotal }}</div>
        ...
        <div class="tour-item">
            <div class="tour-item-left">
                ...
                <div style="min-width:0">
                    ...
                    <div class="tour-meta">
                        <span>📅 {{ $schedule->start_date->format('d/m/Y') }} →
                            {{ $schedule->end_date->format('d/m/Y') }}</span>
                        <span>👥 {{ $schedule->bookings->sum('participant_count') }} khách</span>
            ...
            <div class="tour-item-right">
                ...
                <a href="{{ route('guide.tour.detail', $schedule->schedule_id) }}" class="btn btn-primary btn-sm">Xem
                    chi tiết</a>
            </div>
        </div>
        @endforeach
