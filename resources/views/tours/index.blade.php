...
@section('meta_description', 'Tìm kiếm và đặt tour du lịch Việt Nam uy tín, giá tốt. Filter theo danh mục, giá, thời
    gian.')
                ...
                <div class="filter-card">
                    ...
                    <form action="{{ route('tours.index') }}" method="GET" id="filterForm">
                        ...
                        <div class="filter-section">
                            ...
                            <div class="price-row">
                                <input class="filter-input" type="number" name="min_price" placeholder="Từ"
                                    value="{{ request('min_price') }}" min="0">
                                <input class="filter-input" type="number" name="max_price" placeholder="Đến"
                        ...
                        <div class="filter-section">
                            ...
                            <a href="{{ route('tours.index') }}" class="filter-reset"
                        ...
                        @foreach ($tours as $i => $tour)
                            <a href="{{ route('tours.show', $tour->tour_id) }}" class="tour-card">
                                    ...
                                    <div class="tour-card-overlay">
                                        @if ($tour->category)
                                            <span class="badge badge-blue"
                                                style="font-size:.7rem">{{ $tour->category->name }}</span>
                                        @endif
                                    </div>
                                </div>
                                <div class="tour-card-body">
                                    ...
                                    @if ($tour->description)
                                        <div
                                            style="font-size:.8rem;color:var(--text-light);margin-bottom:10px;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;">
                                            {{ $tour->description }}
                                        </div>
                                    @endif
                                    ...
                                    <div class="tour-card-footer">
                                        ...
                                        <span class="btn btn-accent" style="padding:8px 16px;font-size:.8rem">Xem chi
                                            tiết</span>
                                    </div>
                                </div>
                            </a>
