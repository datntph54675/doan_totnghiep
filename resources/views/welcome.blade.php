        ...
        <div class="container">
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:60px; align-items:center; padding:100px 0 160px;">
                <div class="hero-content">
                    ...
                    <p>Chúng tôi mang đến hành trình trọn gói — từ Hà Nội đến Hội An, từ Sapa đến Phú Quốc. Đặt tour dễ
                        dàng, an toàn, giá tốt nhất.</p>
                    <div class="hero-btns">
                        <a href="{{ route('tours.index') }}" class="btn btn-accent">
                            <i class="fas fa-search"></i> Tìm Tour Ngay
                        </a>
                        <a href="#featured" class="btn"
                            style="background:rgba(255,255,255,.12); color:#fff; border:1.5px solid rgba(255,255,255,.3); backdrop-filter:blur(8px);">
                ...
                <div style="display:flex;align-items:center;justify-content:center;">
                    <div style="width:400px;height:400px;position:relative;">
                        <div
                            style="position:absolute;inset:0;background:rgba(0,102,204,.15);border-radius:50%;animation:pulse 3s infinite;">
                        </div>
                        <div
                            style="position:absolute;inset:20px;background:rgba(0,102,204,.1);border-radius:50%;animation:pulse 3s infinite .5s;">
                        </div>
                        <div
                            style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;flex-direction:column;color:rgba(255,255,255,.6);font-size:5rem;">
                            🗺️
        ...
        <div class="container">
            ...
            <div class="why-grid">
                <div class="why-card">
                    ...
                    <div class="why-desc">Cam kết hoàn tiền 100% nếu tour bị hủy. Bảo hiểm du lịch đầy đủ cho mọi chuyến đi.
                    </div>
                </div>
                <div class="why-card">
                    <div class="why-icon"><i class="fas fa-dollar-sign"></i></div>
                    <div class="why-title">Giá Tốt Nhất</div>
                    <div class="why-desc">So sánh và tìm mức giá tốt nhất. Không phụ phí ẩn, minh bạch từ đầu đến cuối.
                    </div>
                </div>
                <div class="why-card">
                    <div class="why-icon"><i class="fas fa-user-tie"></i></div>
                    <div class="why-title">HDV Chuyên Nghiệp</div>
                    <div class="why-desc">Đội ngũ hướng dẫn viên giàu kinh nghiệm, nhiệt tình, thông thạo nhiều ngoại ngữ.
                    </div>
                </div>
                <div class="why-card">
